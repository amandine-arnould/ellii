...
Activity.all.each do |act|
  [
    Time.strptime("02/09/2021 14:00", "%d/%m/%Y %H:%M"),
    Time.strptime("02/09/2021 16:45", "%d/%m/%Y %H:%M"),
    Time.strptime("03/09/2021 14:00", "%d/%m/%Y %H:%M"),
    Time.strptime("03/09/2021 16:45", "%d/%m/%Y %H:%M"),
    Time.strptime("04/09/2021 14:00", "%d/%m/%Y %H:%M"),
    Time.strptime("04/09/2021 16:45", "%d/%m/%Y %H:%M"),
    Time.strptime("07/09/2021 14:00", "%d/%m/%Y %H:%M"),
    Time.strptime("07/09/2021 16:45", "%d/%m/%Y %H:%M")
  ].each do |hour|
