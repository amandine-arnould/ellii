...
Activity.create!(title: "Echecs", description: "Le jeu d'échecs, ou les échecs, est un jeu de société opposant deux joueurs de part et d'autre d'un tablier appelé échiquier composé de soixante-quatre cases, 32 claires et 32 sombres nommées les cases blanches et les cases noires.", duration: 60, remote: true, user_id: teacher_3.id, max_participants: 2, mind: true, min_participants: 2, admin_validation: true )
#on bouge à distance
# ACTIVITIES_BODY = ["Yoga", "Danse", "Badminton", "Renforcement musculaire", "Marche"]
Activity.create!(title: "Maquillage", description: "Le maquillage est l'utilisation de produits cosmétiques a pour l'embellissement du visage, notamment de sa peau, et la modification des traits du visage et du corps pour la création de personnages au cinéma ou au théâtre.", duration: 45, remote: true, user_id: teacher_4.id, max_participants: 14, mind: true, min_participants: 4, admin_validation: true )
